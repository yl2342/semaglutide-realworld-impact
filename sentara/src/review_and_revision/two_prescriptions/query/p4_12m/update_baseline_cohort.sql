--  DROP IF EXISTS 
IF OBJECT_ID('SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_two_prescriptions', 'U') IS NOT NULL
    DROP TABLE SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_two_prescriptions;
...
semaglutide_study_period AS (
    ...
    FROM 
        semaglutide s
    WHERE
        s.semaglutide_order_sum >= 2  -- At least 2 prescriptions
),
...
SELECT * 
INTO SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_two_prescriptions
