WITH baseline_cohort AS (
    SELECT 
        *
    FROM 
        SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_two_prescriptions_6m_apart
),
...
/* Had total_cholesterol data in all 7 periods */
