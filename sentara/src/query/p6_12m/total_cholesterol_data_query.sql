...
total_cholesterol_combined AS (
    SELECT 
        ...
        CASE 
			...
			WHEN base.semaglutide_initiate_date_plus_36m <= total_cholesterol.total_cholesterol_visit_date 
                AND total_cholesterol.total_cholesterol_visit_date < base.semaglutide_initiate_date_plus_48m THEN '3'
            ELSE NULL 
        END AS period_12m
    FROM 
    ...
    WHERE
        total_cholesterol.total_cholesterol_visit_date BETWEEN semaglutide_initiate_date_minus_24m AND semaglutide_initiate_date_plus_48m        
),
