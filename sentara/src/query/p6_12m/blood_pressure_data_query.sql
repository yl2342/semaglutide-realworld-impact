...
bp_combined AS (
    SELECT 
        ...
        CASE 
			...
			WHEN base.semaglutide_initiate_date_plus_24m <= bp.bp_visit_date 
                AND bp.bp_visit_date < base.semaglutide_initiate_date_plus_36m THEN '2'
			WHEN base.semaglutide_initiate_date_plus_36m <= bp.bp_visit_date 
                AND bp.bp_visit_date < base.semaglutide_initiate_date_plus_48m THEN '3'
            ELSE NULL 
        END AS period_12m
    FROM 
    ...
    WHERE
        bp.bp_visit_date BETWEEN semaglutide_initiate_date_minus_24m AND semaglutide_initiate_date_plus_48m        
),
