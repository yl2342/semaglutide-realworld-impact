WITH baseline_cohort AS (
    SELECT 
        *
    FROM 
        SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p5_6m
),
...
all_condition_visit AS (
    ...
    WHERE
        ...
        -- in study time range 
        AND vo.visit_start_datetime BETWEEN base.semaglutide_initiate_date_minus_12m AND base.semaglutide_initiate_date_plus_18m
),
