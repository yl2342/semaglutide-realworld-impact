--  DROP IF EXISTS 
IF OBJECT_ID('SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p2_12m', 'U') IS NOT NULL
    DROP TABLE SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p2_12m;
...
semaglutide_initiate_patients_first_last_visit_date AS (
    ...
    FROM (
        ...
        AND CAST(visit_start_datetime AS DATE) <= '2025-01-01' -- Truncate 2025
...
SELECT * 
INTO SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p2_12m
