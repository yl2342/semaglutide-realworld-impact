--  DROP IF EXISTS 
IF OBJECT_ID('SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p8_6m', 'U') IS NOT NULL
    DROP TABLE SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p8_6m;
...
semaglutide_study_period AS (
    SELECT DISTINCT
		...
		CAST(DATEADD(MONTH, 30, s.first_semaglutide_prescribe_date) AS DATE) AS semaglutide_initiate_date_plus_30m,
...
SELECT * 
INTO SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p8_6m
