--  DROP IF EXISTS 
IF OBJECT_ID('SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_subcutaneous', 'U') IS NOT NULL
    DROP TABLE SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_subcutaneous;
...
semaglutide_raw AS (
    SELECT 
        ...
        CASE
            ...
            ELSE 'Subcutaneous' -- Default to subcutaneous if not oral
...
baseline_cohort AS (
    ...
    WHERE ss.first_order_route = 'Subcutaneous'  -- Filter for subcutaneous route
)
  
-- Store baseline cohort table
SELECT * 
INTO SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_subcutaneous
