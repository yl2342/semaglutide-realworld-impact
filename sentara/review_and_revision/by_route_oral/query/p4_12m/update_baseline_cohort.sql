--  DROP IF EXISTS 
IF OBJECT_ID('SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_oral', 'U') IS NOT NULL
    DROP TABLE SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_oral;
...
semaglutide_raw AS (
    SELECT 
        ...
        -- IF drug_source_value contains 'tablet', then the route is oral
        CASE
...
semaglutide_initiate_patients_first_last_visit_date AS (
    ...
    FROM (
        ...
        AND CAST(visit_start_datetime AS DATE) <= '2025-01-01'  -- Truncate until now
...
SELECT * 
INTO SandboxDClinicalResearch.YL_semaglutide_realword_impact_baseline_cohort_p4_12m_rr_by_route_oral
