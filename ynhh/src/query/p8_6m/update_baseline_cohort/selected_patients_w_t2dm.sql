...
WITH selected_patients_w_t2dm AS (
    ...
    FROM (
        ...
        WHERE
            co.person_id IN (SELECT person_id FROM PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/semaglutide_study_period.parquet'))
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/selected_patients_w_t2dm.parquet' (FORMAT PARQUET);
