    ...
    SELECT 
        ...
        CASE 
            ...
            WHEN s.semaglutide_initiate_date_plus_24m <= b.bmiw_visit_date 
                AND b.bmiw_visit_date < s.semaglutide_initiate_date_plus_30m THEN '4'
            WHEN s.semaglutide_initiate_date_plus_30m <= b.bmiw_visit_date 
                AND b.bmiw_visit_date < s.semaglutide_initiate_date_plus_36m THEN '5'
            ELSE NULL 
        END AS period_6m
    FROM 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/semaglutide_study_period.parquet') s 
    LEFT JOIN 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/semaglutide_initiate_patients_first_last_visit_date.parquet') fl      
        ON s.person_id = fl.person_id
    LEFT JOIN 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/bmiw_visit.parquet') b
        ON s.person_id = b.person_id
    WHERE 
        (s.semaglutide_initiate_date_plus_36m <= fl.last_visit_date)  -- Ensure in observation period
...
selected_patients_w_all_periods AS (
    SELECT 
        ...
        MAX(semaglutide_initiate_date_plus_36m) AS study_period_end,
...
baseline_cohort AS (
    SELECT 
        ...
        ss.semaglutide_initiate_date_plus_30m,
    ...
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/semaglutide_study_period.parquet') ss
        ON sp.person_id = ss.person_id
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/selected_patients_w_t2dm.parquet') t
        ON sp.person_id = t.person_id
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/selected_patients.parquet') p 
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/baseline_cohort.parquet' (FORMAT PARQUET);
