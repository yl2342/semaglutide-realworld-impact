...
WITH selected_patients AS (
    ...
    WHERE
        person_id IN (
            SELECT person_id FROM PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/semaglutide_study_period.parquet'))
)

SELECT * FROM  selected_patients

)
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p8_6m/selected_patients.parquet' (FORMAT PARQUET);
