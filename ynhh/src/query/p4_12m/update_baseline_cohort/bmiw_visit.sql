...
WITH height_m AS (
    ...
    WHERE 
        ...
        AND om.person_id IN (SELECT person_id FROM PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p4_12m/selected_patients.parquet'))
...
bmiw_visit AS (
	...
	LEFT JOIN 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p4_12m/selected_patients.parquet') p ON w.person_id = p.person_id
	WHERE
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p4_12m/bmiw_visit.parquet' (FORMAT PARQUET);
