...
WITH semaglutide_initiate_patients_first_last_visit_date AS (
    ...
    FROM (
        ...
        AND person_id IN (SELECT person_id FROM PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p2_12m/semaglutide_study_period.parquet'))
    ) tmp
    GROUP BY 
        person_id
)
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p2_12m/semaglutide_initiate_patients_first_last_visit_date.parquet' (FORMAT PARQUET);
