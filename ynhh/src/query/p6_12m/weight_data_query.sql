...
bmiw_visit AS (
	SELECT 
		*
	FROM 
	PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p6_12m/bmiw_visit.parquet')
),
	...
	SELECT 
		...
		CASE 
            ...
            WHEN base.semaglutide_initiate_date_plus_24m <= wt.bmiw_visit_date 
                AND wt.bmiw_visit_date < base.semaglutide_initiate_date_plus_36m THEN '2'
            WHEN base.semaglutide_initiate_date_plus_36m <= wt.bmiw_visit_date 
                AND wt.bmiw_visit_date < base.semaglutide_initiate_date_plus_48m THEN '3'
            ELSE NULL 
        END AS period_12m
	FROM 
