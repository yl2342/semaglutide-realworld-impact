...
semaglutide_study_period AS (
    SELECT DISTINCT
        ...
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '48 months' AS DATE) AS semaglutide_initiate_date_plus_48m
    FROM 
        semaglutide s
)
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p6_12m/semaglutide_study_period.parquet' (FORMAT PARQUET);
