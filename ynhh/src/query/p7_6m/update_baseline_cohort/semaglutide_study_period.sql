...
semaglutide_study_period AS (
    SELECT DISTINCT
        ...
        CAST(s.first_semaglutide_prescribe_date - INTERVAL '6 months' AS DATE) AS semaglutide_initiate_date_minus_6m,
        CAST(s.first_semaglutide_prescribe_date - INTERVAL '12 months' AS DATE) AS semaglutide_initiate_date_minus_12m,
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '6 months' AS DATE) AS semaglutide_initiate_date_plus_6m,
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '12 months' AS DATE) AS semaglutide_initiate_date_plus_12m,
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '18 months' AS DATE) AS semaglutide_initiate_date_plus_18m,
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '24 months' AS DATE) AS semaglutide_initiate_date_plus_24m,
        CAST(s.first_semaglutide_prescribe_date + INTERVAL '30 months' AS DATE) AS semaglutide_initiate_date_plus_30m
    FROM 
        semaglutide s
)
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/interim_tables/p7_6m/semaglutide_study_period.parquet' (FORMAT PARQUET);
