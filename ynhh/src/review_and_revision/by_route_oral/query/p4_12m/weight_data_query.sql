...
bmiw_visit AS (
	SELECT 
		*
	FROM 
		PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/by_route_oral/interim_tables/p4_12m/bmiw_visit.parquet')
),
