...
WITH semaglutide_study_period_w_bmi AS (
    SELECT 
        ...
        END AS period_12m
    FROM 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/semaglutide_study_period.parquet') s 
    LEFT JOIN 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/semaglutide_initiate_patients_first_last_visit_date.parquet') fl      
        ON s.person_id = fl.person_id
    LEFT JOIN 
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/bmiw_visit.parquet') b
...
baseline_cohort AS (
    ...
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/semaglutide_study_period.parquet') ss
        ON sp.person_id = ss.person_id
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/selected_patients_w_t2dm.parquet') t
        ON sp.person_id = t.person_id
    LEFT JOIN
        PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/selected_patients.parquet') p 
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/baseline_cohort.parquet' (FORMAT PARQUET);
