...
semaglutide AS (
    SELECT 
        ...
        COUNT(DISTINCT drug_exposure_id) OVER (
            PARTITION BY person_id
...
TO '/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions/interim_tables/p4_12m/semaglutide_study_period.parquet' (FORMAT PARQUET);
