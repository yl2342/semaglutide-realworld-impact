...
total_cholesterol_combined AS (
    ...
    WHERE
        total_cholesterol.total_cholesterol_visit_date BETWEEN semaglutide_initiate_date_minus_24m AND semaglutide_initiate_date_plus_24m        
),
...
/* Had total_cholesterol data in all 4 periods */
