...
WITH baseline_cohort AS (
	SELECT 
		*
	FROM 
		PARQUET_SCAN('/home/jupyter/p2r2583347krumholz/Yuntian/semaglutide_realworld_impact/review_and_revision/two_prescriptions_6m_apart/interim_tables/p4_12m/baseline_cohort.parquet')
),
...
all_condition_visit AS (
    ...
    WHERE
        ...
        -- in study time range 
        vo.visit_start_datetime BETWEEN base.semaglutide_initiate_date_minus_24m AND base.semaglutide_initiate_date_plus_24m
),
